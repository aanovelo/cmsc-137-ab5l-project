...
of the cloud beyond hosting. The science community is one group that is 
interested in leveraging the use of cloud. They are looking at the possibility 
of running entire scientific applications on the cloud. The nature of these 
scientific applications differs greatly from web applications. Most scientific 
applications require multiple compute nodes and requires plenty of inter-node 
communications.
