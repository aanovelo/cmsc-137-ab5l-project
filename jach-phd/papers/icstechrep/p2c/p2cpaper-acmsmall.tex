...
In order to start instances, virtual machine images must be present. 
Thus, several images were uploaded which include Ubuntu Server 12.04, 
Debian 7, and Windows XP.


\subsection{Running a Web application on P2C}
In order to test P2C, INSTANT was deployed on an instance in P2C. It is 
a web application for administering exam to students. The machine instance 
used has 4 VCPU, 1G RAM, and 10G disk. It uses the standard LAMP stack 
mentioned above.
