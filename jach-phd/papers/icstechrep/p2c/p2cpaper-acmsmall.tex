...
entire scientific applications on the cloud. These applications are compute and 
communication intensive which differs greatly from web applications. This work 
explores this possibility through the Peak2Cloud. 
...
\section{Methodology}
Peak2Cloud is a combination of hardware, software, and network configuration. 
In this section we describe how these are combined to achieve the desired 
results. Openstack is the cloud software used as previously mentioned.
...
connects the controller and the nodes. Figure~\ref{fig:nodes} and Figure~
\ref{fig:switch} shows the nodes and the switch respectively.
