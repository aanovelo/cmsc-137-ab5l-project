...
This paper will focus on IaaS private clouds using Openstack, a popular and 
widely supported framework described in the next section.

IaaS clouds today are used mainly for hosting web sites and deploying web 
applications. They provide instances with operating systems that can run web 
server software, scripting engine, and database management systems. A 
