...
Cloud computing has become a buzzword in today's modern computing, though there
 is no agreed upon meaning of the term. In 2011, \cite{mell_nist_2011} of NIST  
...
A cloud can be deployed in several ways. {\it Private} clouds are operated for 
...
the public. Lastly, hybrid clouds are composition of two or more clouds
\cite{mell_nist_2011}.
...
Several components of Openstack which are developed separately. The names in 
parenthesis represent the project name used by the developers.
